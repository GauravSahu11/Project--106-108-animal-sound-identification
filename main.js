//https://teachablemachine.withgoogle.com/models/2c1bYTafq/
...
function startClassifictaion() {
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/YyK7XYiYO/model.json', modelReady);
}
